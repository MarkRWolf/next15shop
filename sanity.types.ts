...
// Query: *[_type == "product" && !(_id in path("drafts.*"))] | order(lower(name_daDK) asc) [0...$range] {    ...,    "category": coalesce(categories[0]->title, ""),  }
export type PRODUCTS_IN_RANGE_QUERYResult = Array<{
  _id: string;
  _type: "product";
  _createdAt: string;
  _updatedAt: string;
